<nav class="navbar fixed-top navbar-dark bg-dark" id="navbar">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav ml-auto mr-3">
            <li class="nav-item ">
                <a href="<?= base_url('booked'); ?>" class="nav-link text-success">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-card-checklist" viewBox="0 0 16 17">
        ...
        <ul class="navbar-nav">
            <li class="nav-item ">
                <a href="<?= base_url('cart'); ?>" class="nav-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-cart3" viewBox="0 0 16 17">
        ...
        <ul class="navbar-nav mr-3">
            <li class="nav-item font-weight-bold">
                <?php if (isset($_SESSION['name'])) { ?>
                    <a class="nav-link ml-0" href="<?= base_url("user"); ?>">
                        ...
                        <?= $_SESSION['name']; ?>
                    <?php } else { ?>
                        <a class="nav-link ml-2" href="<?= base_url("login"); ?>">
                        <?= "Login";
                    } ?>
                        </a>
            </li>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <?php if (isset($_SESSION['name']) && $_SESSION['role_id'] == 2) { ?>
                    <li class="nav-item">
                        <a class="nav-link font-weight-bold text-info" href="<?= base_url('admin'); ?>">
